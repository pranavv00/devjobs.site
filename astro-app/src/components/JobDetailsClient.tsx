  ...
  return (
    <main className="min-h-screen pb-32 pt-8 relative">
      <div className="container mx-auto px-4 max-w-6xl">
        <a href="/" className="inline-flex items-center gap-2 text-zinc-600 hover:text-white mb-10 transition-colors font-black uppercase tracking-widest text-[10px] group">
