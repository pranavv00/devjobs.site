  ...
  return (
    <main className="min-h-screen pb-32">
      <div className="container mx-auto px-4 pt-12 relative z-10 max-w-[1400px]">
        <a href="/" className="inline-flex items-center gap-2 text-white/30 hover:text-purple-400 mb-8 transition-all font-bold uppercase tracking-widest text-xs">
          <ArrowLeft size={16} />
        ...
        {savedJobs.length > 0 ? (
          ...
          >
            ...
            <a href="/" className="px-10 py-4 rounded-2xl bg-purple-600 text-white font-black uppercase tracking-widest text-xs hover:bg-purple-500 transition-all shadow-xl shadow-purple-500/20">
              Start Discovering
            </a>
          </motion.div>
        )}
