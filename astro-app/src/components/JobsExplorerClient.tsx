...
import { Search, Filter, Calendar, MapPin, Briefcase, DollarSign, X, ChevronDown } from "lucide-react";
import { motion, AnimatePresence } from "framer-motion";

export default function JobsExplorerClient({ initialJobs }: { initialJobs: Job[] }) {
  ...
  return (
    <main className="min-h-screen pb-32 pt-12">
      <div className="container mx-auto px-4">
        {/* Header Section */}
        <div className="mb-12">
          <a href="/" className="inline-flex items-center gap-2 text-white/30 hover:text-purple-400 mb-8 transition-all font-bold uppercase tracking-widest text-[10px] group">
